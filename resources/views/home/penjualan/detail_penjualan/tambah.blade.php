              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td> <h6 class="mb-0 text-sm m-3">{{ $dp->produk->nama }}</h6> </td>
                      <td> <p class="text-xs text-secondary mb-0">{{ $dp->JumlahProduk }}</p> </td>
                      <td> <p class="text-xs text-secondary mb-0">Rp.{{number_format( $dp->produk->harga)}}</p> </td>
