        ...
        <div class="card my-4">
          ...
          <div class="card-body px-0 pb-2">
            <div class="table-responsive p-0">
                <a href="/pelanggan/tambah" class="btn btn-warning mx-3">Tambah Data</a>
              <table class="table align-items-center mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    <td> <h6 class="mb-0 text-sm m-3">{{$pelanggan->nama}}</h6> </td>
                    <td> <p class="text-xs text-secondary mb-0">{{$pelanggan->alamat}}</p> </td>
                    <td> <p class="text-xs text-secondary mb-0">{{ $pelanggan->no_telp }}</p> </td>
